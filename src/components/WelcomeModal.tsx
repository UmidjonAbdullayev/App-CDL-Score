      ...
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[9998] p-4">
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full px-8 py-8 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4 leading-relaxed">
            Your account is ready. We've added
          </p>
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-5 py-3 mb-5">
            <p className="text-3xl font-black text-emerald-600">3 Free Searches</p>
            <p className="text-xs text-emerald-700 mt-1">Start evaluating CDL-A drivers right now</p>
          </div>
