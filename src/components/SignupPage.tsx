              ...
              <form onSubmit={handleStep1} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Optional — e.g. A1B2C3D4"
                    className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition font-mono tracking-wider"
                  />
